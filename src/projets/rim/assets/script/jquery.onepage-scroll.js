...
!function($){
  // Fonctionalité par défault
  var defaults = {
    sectionContainer: "section", // Prend la balise "section" comme contenu par défaut
    easing: "ease", // Pour la fluidité du scroll
    animationTime: 1000, // Temps d'animations
    pagination: true, // Affiche la pagination
    updateURL: false, // Mettre à jour l'URL dans la barre d'adresse
  ...
  $.fn.onepage_scroll = function(options){
    ...
    // Créer les paginations et les afficher
    if(settings.pagination == true) {
